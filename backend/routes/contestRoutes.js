...
import { rulesController, problemController, isFirstTime, acceptController, contestDetails,getParticipantsByContestId } from '../controllers/contestController.js';
...
router.post('/getDetails', authMiddleware, basicUserInfo, async (req, res) => {
    await contestDetails(req, res);
});

router.get('/participants/:id', async (req, res) => {
    await getParticipantsByContestId(req, res);
});
