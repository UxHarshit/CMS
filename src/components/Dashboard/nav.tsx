...
export default function Nav({ name, email, image, username, isAdmin }: { name: string, email: string, image: string, username: string, isAdmin: boolean }) {
    ...
    return (
        <>
            <header className=" backdrop:blur-sm backdrop-blur  fixed  w-full shadow-sm z-10">
